...
export default function MascotasTransito({ navigation }) {
  ...
  useEffect(() => {
    fetch("http://192.168.18.24/mascotas-api/endpoints/mascotas/transito.php")
      .then(res => res.json())
      .then(data => {
        setMascotas(data);
      ...
      >
        ...
        >
          <View style={styles.imageContainer}>
            ...
            >
              <View style={styles.transitBadge}>
                ...
                <Text style={styles.transitText}>Tránsito</Text>
              </View>
            </LinearGradient>
          </View>
          ...
          <View style={styles.cardContent}>
            ...
            >
              <Ionicons name="home" size={16} color="#2c3e50" />
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerSection}>
        ...
        >
          ...
          <Text style={styles.title}>Mascotas en Tránsito</Text>
          <Text style={styles.subtitle}>Hogar temporal mientras encuentran familia</Text>
        </LinearGradient>
      </View>
...
const styles = StyleSheet.create({
  ...
  transitBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(168, 237, 234, 0.9)',
    borderRadius: 12,
    paddingHorizontal: 8,
    paddingVertical: 4,
    gap: 4,
